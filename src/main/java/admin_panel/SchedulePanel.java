...
//    private static final ArrayList<Screen> screens_list = new ArrayList<>();
    ...
    private com.raven.datechooser.DateChooser date_chooser;
    /** 
     * Creates new form P3_Schedule
     */
    public SchedulePanel() {
        initComponents();
        date_chooser = new com.raven.datechooser.DateChooser();
        ...
        try {
            while(result.next()){  
                ...
                Object[] row = {title, selected_date.toString(), start_time, end_time, price,screen_number};
                table_model.addRow(row);    
            }
        } catch (SQLException ex) {            
            Logger.getLogger(SchedulePanel.class.getName()).log(Level.SEVERE, null, ex);
        }
        schedule_table.setModel(table_model);
        displayIcon();
    }
    ...
    private void initComponents() {
        ...
        comboBoxMovie.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                comboBoxMoviePropertyChange(evt);
            }
        });
...
//        // TODO add your handling code here:
        ...
        Object[] row = {title, date.toString(), start_time_text, end_time_text, price, screen_number};
    ...
    private void bt_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_deleteActionPerformed
        ...
        if (choice == 0){
            int selected_index = schedule_table.getSelectedRow();
    ...
    private void comboBoxMoviePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_comboBoxMoviePropertyChange
        // TODO add your handling code here:
     
    }//GEN-LAST:event_comboBoxMoviePropertyChange

    private void schedule_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_schedule_tableMouseClicked
        // TODO add your handling code here:
        int selected_index = schedule_table.getSelectedRow();
        
//        comboBoxMovie.setSelectedItem(ABORT);
//        String title = (String) tableModel.getValueAt(selected_row, 0);
